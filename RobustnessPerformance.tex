...
%\chapter*{Dédicaces}
 ...
 %\begin{center}
	...
	%\begin{Large} \textbf{À mes frères a L’Algérie entière des montagnes et du djurdjura } \end{Large}\\
 ...
 %\end{center}
 %\begin{flushright} \begin{Large} \textit{BOUYOUCEF  koulouch HARAM} \end{Large} \end{flushright}
...
\chapter{ Analyse d'une commande proportionnelle intégrales}
 \addcontentsline{toc}{chapter}{Analyse d'une commande proportionnelle intégraless}
